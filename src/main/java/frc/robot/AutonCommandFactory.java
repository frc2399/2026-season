...
public class AutonCommandFactory {
    ...
    //                 buildPathDeferred(
    //                         FieldConstants.PoseConstants.DEPOT_OVER_THE_BUMP,
    // bumpAndDepotConstraints),
    //                 // move into intaking position while driving
    //                 drive.driveToPoseOnExecute(),
    //                 // buildPathDeferred(FieldConstants.PoseConstants.NEUTRAL_ZONE_BORDER,
    // constraints),
    //                 Commands.parallel(
    ...
    //                 // drive.driveToPoseOnExecute()),
    //                 buildPathDeferred(FieldConstants.PoseConstants.DEPOT_OVER_THE_BUMP,
    // constraints),
    ...
    //                 // get into shooting position while driving
    //                 drive.driveToPoseOnExecute(),
    //                 buildPathDeferred(FieldConstants.PoseConstants.HUB_MIDDLE,
    // bumpAndDepotConstraints),
    //                 drive.driveToPoseOnExecute());
    //     }
}
