...
public class SpindexerWorldsHardware implements SpindexerIO {

    private TalonFX spindexerSparkFlex;
    private final TalonFXConfiguration spindexerPidController;
    ...
    private final TalonFXConfiguration spindexClosedLoopConfig = new TalonFXConfiguration();
    private final RelativeEncoder spindexerEncoder;

    private AngularVelocity desiredVelocity = RadiansPerSecond.of(0);

    TalonFXConfiguration spindexerSparkFlexConfig = new TalonFXConfiguration();

    public SpindexerWorldsHardware(int spindexerGearRatio) {
