                ...
                new Pose(
                        ...
                        FRONT_OF_BLUE_HUB.plus(
                                new Transform2d(
                                        ...
                                        Rotation2d.kZero)));
        public static final Pose DEPOT_SIDE_AUTON_FUEL_CENTER_ON_OUTPOST_SIDE =
                new Pose(
                        "depotSideAutonFuelCenterOnOutpostSide",
                        new Pose2d(
                                new Translation2d(Meters.of(7.72), Meters.of(1.22)),
