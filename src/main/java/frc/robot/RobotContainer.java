...
public class RobotContainer {
  ...
  private static final CommandXboxController driverController = new CommandXboxController(
      RobotConstants.DriveControlConstants.DRIVER_CONTROLLER_PORT);
  private static final CommandXboxController operatorController = new CommandXboxController(
      RobotConstants.DriveControlConstants.OPERATOR_CONTROLLER_PORT);
  ...
  private void setUpAuton() {
    ...
    drive.resetOdometry(new Pose2d(0.2,0.2, Rotation2d.fromDegrees(0)));
  ...
  //     drive.driveToPoseOnExecute(),
  //     // shooting command
  //     commandFactory.buildPath(PoseConstants.TOWER_L1),
  ...
  //     drive.driveToPoseOnExecute(),
  //     // ground intaking command from depot
  //     commandFactory.buildPath(PoseConstants.BUMP_STARTING_LINE),
  //     // move into shooting position while driving
  //     drive.driveToPoseOnExecute(),
  //     // shooting command
  //     commandFactory.buildPath(PoseConstants.TOWER_L1),
  ...
  //     commandFactory.buildPath(PoseConstants.NEUTRAL_ZONE_BORDER),
